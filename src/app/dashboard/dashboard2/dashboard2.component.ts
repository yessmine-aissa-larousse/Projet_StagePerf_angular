...
export class Dashboard2Component {
  ...
  ngOnInit(): void {
    this.formateurService.getNombreFormateurs().subscribe(
      (data: any) => {
        console.log(data);
        this.nombreFormateurs = data.nombreFormateurs;
      },
      (error) => {
        console.error('Erreur lors de la récupération du nombre de formateurs', error);
      }
    );

    this.formateurService.getNombreAdmins().subscribe(
      (data: any) => {
        console.log(data);
        this.nombreAdmins = data.nombreAdmins;
      },
      (error) => {
        console.error('Erreur lors de la récupération du nombre des Administrateurs', error);
      }
    );
  }
